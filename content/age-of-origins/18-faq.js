/* Contenuto tradotto del capitolo — Age of Origins / 18 FAQ. */
var PAGE_I18N = {
  en: `
      <h1>FAQ</h1>
      <div class="hazard"></div>
      <p class="lead">The questions everyone asks at least once, with short answers and links to the chapters for more.</p>

      <h2>For beginners</h2>
      <p><strong>I got attacked and lost everything, what do I do?</strong><br>
      Breathe: troops in the hospital heal, resources come back. Put up a bubble, heal the wounded, and read <a href="01-primi-passi.html">First steps</a> so you don't repeat the mistake.</p>
      <p><strong>Should I restart on a new server?</strong><br>
      Only if you're truly at the start. If you already have weeks of progress, better to fix your priorities where you are.</p>
      <p><strong>What do I do with gold/diamonds?</strong><br>
      As F2P: an extra builder, VIP and little else. See <a href="14-strategia-f2p.html">F2P strategy</a>.</p>
      <p><strong>My food is negative, is that a problem?</strong><br>
      No, it's normal with lots of soldiers: troops don't starve. Just keep enough food for research and healing.</p>

      <h2>On events</h2>
      <p><strong>When should I use speed-ups?</strong><br>
      Almost only on event days that reward what you're speeding up. See <a href="13-eventi.html">Events</a>.</p>
      <p><strong>Is it worth joining a PvP event if I'm small?</strong><br>
      Yes, but from safety: score from monsters and safe gathering, bubble in the hot phases, troops in the alliance rallies.</p>
      <p><strong>Why shouldn't I open chests and packs right away?</strong><br>
      Because opened on the right event day they're also worth points and extra rewards. In the inventory they're safe.</p>

      <h2>On troops</h2>
      <p><strong>Many low troops or a few high ones?</strong><br>
      A few high ones, almost always. Low troops serve as a shield and for gathering. See <a href="05-truppe.html">Troops</a>.</p>
      <p><strong>What's the 1-1-98?</strong><br>
      The monster formation: 1% front, 1% mid, 98% long range. Don't use it in PvP. See <a href="07-formazioni.html">Formations</a>.</p>
      <p><strong>Why do my troops die instead of going to the hospital?</strong><br>
      Hospital full or too small, or the enemy has high lethality. See <a href="06-combattimento.html">Combat</a>.</p>

      <h2>On officers</h2>
      <p><strong>Which officer should I upgrade first?</strong><br>
      The one with the best skills for your main troop that you can raise to high stars. See <a href="08-ufficiali.html">Officers</a>.</p>
      <p><strong>I pulled a legendary, should I drop everything for it?</strong><br>
      Only if you can feed it shards. A legendary stuck at 1 star often performs worse than an epic at full stars.</p>

      <h2>On alliance</h2>
      <p><strong>Can I attack whoever attacked me?</strong><br>
      Ask the R4s first: there might be a NAP or a coordinated response in the works. See <a href="12-alleanza.html">Alliance</a>.</p>
      <p><strong>What happens if I'm inactive for a few weeks?</strong><br>
