...
var PAGE_I18N = {
  en: `
      ...
      <h2>All chapters</h2>
      <p>18 chapters, from first steps to alliance strategy. Follow the order if you're new, or jump to the chapter you need.</p>
...
`,
  es: `
      ...
      <p>18 capítulos, desde los primeros pasos hasta las estrategias de alianza. Sigue el orden si eres nuevo, o salta al capítulo que necesites.</p>
      <div class="card-grid" id="game-chapters"></div>
`,
  fr: `
      ...
      <p>18 chapitres, des premiers pas aux stratégies d'alliance. Suis l'ordre si tu es nouveau, ou saute au chapitre dont tu as besoin.</p>
      <div class="card-grid" id="game-chapters"></div>
`
};
